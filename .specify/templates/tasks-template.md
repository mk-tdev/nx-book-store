...
**Manual Validation**: [How to validate this story works on its own]
...
**Checkpoint**: At this point, User Stories 1 AND 2 should both be manually verifiable
...
- [ ] TXXX Manual validation checklist update (e.g., steps to verify each story)
...
- **User Story 2 (P2)**: Can start after Foundational (Phase 2) - May integrate with US1 but should be manually verifiable
- **User Story 3 (P3)**: Can start after Foundational (Phase 2) - May integrate with US1/US2 but should be manually verifiable
...
- Stop at any checkpoint to manually validate the story
