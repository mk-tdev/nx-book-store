...
**Manual Validation**: [Describe how to validate this manually - e.g., "Validate by doing [specific action] and observing [expected result]"]
...
**Manual Validation**: [Describe how to validate this manually]
